...
if (typeof marked !== 'undefined') {
  ...
  renderer.code = function(code, language) {
    const validLang = (typeof hljs !== 'undefined' && language && hljs.getLanguage(language)) 
      ? language 
      : 'plaintext';
...
async function sendMessage() {
  ...
  try {
    ...
    if (prepBubble) {
      prepBubble.innerHTML = typeof marked !== 'undefined' ? marked.parse(replyText) : replyText;
    }
    ...
    if (prepBubble) prepBubble.textContent = "Tephdy engine offline or disconnected.";
  } finally {
